...
import com.example.vmac.WatBot.network.DirectionsResponse;
import com.example.vmac.WatBot.network.RetrofitInterface;
import com.example.vmac.WatBot.network.model.Step;
import com.example.vmac.WatBot.utils.LocationCalc;
...
public class ArCamActivity extends FragmentActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public ArFragmentSupport arFragmentSupport;
    private World world;
