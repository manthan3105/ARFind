...
public class ChooseModel extends AppCompatActivity {
    ...
    // button for each availabfle classifier
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inceptionQuant = (Button)findViewById(R.id.inception_quant1);
        Submit = (Button)findViewById(R.id.inception_quant2);
        AR = (Button)findViewById(R.id.inception_quant3);

        AR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ChooseModel.this, PoiBrowserActivity.class);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ChooseModel.this, MainActivity.class);
                startActivity(intent);
            }
        });
